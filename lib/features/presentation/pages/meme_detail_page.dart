...
import 'package:meme_editor_mobile/features/presentation/pages/meme_export_page.dart';
...
class _MemeDetailViewState extends State<MemeDetailView> {
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              _buildActionButton(
                                ...
                                label: 'Export',
                                onPressed: () => _openExportPage(context, memeEdit),
  ...
  void _openExportPage(BuildContext context, MemeEdit memeEdit) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MemeExportPage(
          meme: widget.meme,
          memeEdit: memeEdit,
        ),
      ),
